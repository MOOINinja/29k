//
//  StartWithWhyInformationPopup.swift
//  twentyninek
//
...
class StartWithWhyInformationPopup: UIView, UIScrollViewDelegate {
    ...
    let infoLabel: UITextView = {
        ...
        label.text = "Connect to your values to discover what you’re looking for. Our Why Canvas helps you create your story."
    ...
    let pageOneImage: UIImageView = {
        let img = UIImageView()
        img.image = UIImage(named: "StartWithWhyPageOne")?.withRenderingMode(.alwaysOriginal)
    ...
    let pageTwoImage: UIImageView = {
        let img = UIImageView()
        img.image = UIImage(named: "StartWithWhyPageTwo")?.withRenderingMode(.alwaysOriginal)
        img.contentMode = .scaleAspectFit
        return img
    }()
