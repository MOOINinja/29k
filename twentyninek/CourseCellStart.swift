...
class CourseCellStart: BaseCollectionCell {
    ...
    let button: UIButton = {
        ...
        btn.setImage(UIImage(named: "startCourseIcon")?.withRenderingMode(.alwaysOriginal), for: .normal)
    ...
    let courseTitle: UILabel = {
        ...
        label.textColor = UIColor.rgb(red: 88, green: 68, blue: 179, alpha: 1)
    ...
    let courseDescription: UILabel = {
        let label = UILabel()
        label.text = "Understanding your values"
