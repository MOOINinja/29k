...
class CourseCellDone: BaseCollectionCell {
    ...
    let button: UIButton = {
        ...
        btn.setImage(UIImage(named: "viewCourseIcon")?.withRenderingMode(.alwaysOriginal), for: .normal)
    ...
    let courseDescription: UILabel = {
        let label = UILabel()
        label.text = "Self assessment of where you are in life"
